...
public class Lose extends JFrame {
    public Lose(){
        ...
        JLabel content= new JLabel("패배셨습니다.");
        JLabel congratution= new JLabel("아쉽습니다.");
        ...
        ImageIcon image = new ImageIcon(Lose.class.getResource("lose2.PNG"));
        ...
        ImageIcon image2 = new ImageIcon(Lose.class.getResource("패배.PNG"));
